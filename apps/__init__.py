...
from apps.netTraffic.netTraffic import netTraffic_bp
from apps.terminalStatus.terminalStatus import terminalStatus_bp
...
def create_app():
    ...
    app.register_blueprint(netTraffic_bp)
    app.register_blueprint(terminalStatus_bp)
